...
class Linear(nn.Linear, Lora_ALayer):
    # Lora_A implemented in a dense layer
    def __init__(
        self,
        adapter_name: str,
        in_features: int,
        ...
        **kwargs,
        ...
        Lora_ALayer.__init__(self, in_features=in_features, out_features=out_features)
...
if is_bnb_available():
    # TODO: for split and activate_fn
    class Linear8bitLt(bnb.nn.Linear8bitLt, Lora_ALayer):
        # Lora_A implemented in a dense layer
        def __init__(
            self,
            adapter_name,
