...
torchrun --nproc_per_node $WORKER_GPU --nnodes $WORKER_NUM --node_rank=$ARNOLD_ID --master_addr $WORKER_0_HOST --master_port $PORT -m debugpy --connect localhost:6032 inference.py --config_path=$1
