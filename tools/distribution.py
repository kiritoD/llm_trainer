...
def hist(data, model_name, dt, alpha=0.8):
    ...
    # 显示图表
    plt.savefig(
        f"/hpc2hdd/home/fwang380/dongjunwei/llm_trainer/model_output/ditributions/hist_{model_name}_{dt}_{title}.jpg"
    )
    plt.clf()
...
def heatmap(data, model_name, dt):
    ...
    plt.savefig(
        f"/hpc2hdd/home/fwang380/dongjunwei/llm_trainer/model_output/ditributions/heatmap_{model_name}_{dt}_{title}.jpg"
    )
    plt.clf()
...
def weight_key_mapping(weight_data, model_name):
    key_mapping = {"roberta-base": "layer", "llama2": "layers"}
    module_index_mapping = {"roberta-base": 3, "llama2": 2}
...
def weight_anaylsis(weight, dt="", model_name="roberta-base", interval=5):
    key_mapping = {
        "roberta-base": {"q": "query", "k": "key", "v": "value"},
        "llama2": {"q": "q_proj", "k": "k_proj", "v": "v_proj"},
    }
